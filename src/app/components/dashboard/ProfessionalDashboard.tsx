...
import { getAppointments, saveAppointments } from '@/app/lib/mockData';
...
export const ProfessionalDashboard: React.FC = () => {
  ...
  const stats = {
    ...
    earnings: appointments.filter(a => a.status === 'completed').length * 100, // Mock earnings
  };
    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-4xl font-bold text-white mb-2">Professional Dashboard</h1>
          ...
          <div className="space-y-4">
            {appointments.map((appointment, index) => (
              <motion.div
                ...
                whileHover={{ x: 5 }}
                className="glass rounded-xl p-6 glow-hover-purple transition-all"
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-lg font-semibold text-white">User #{appointment.userId.slice(-4)}</h3>
